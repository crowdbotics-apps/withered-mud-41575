"""
Django settings for withered_mud_41575 project.
...
ROOT_URLCONF = 'withered_mud_41575.urls'
...
WSGI_APPLICATION = 'withered_mud_41575.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_mud_41575 API",
    "DESCRIPTION": "API documentation for withered_mud_41575 App",
    "VERSION": "v1",
}
